...
class book {
  constructor(title, author, isbn) {
    // assign true or false to availability as per the availability
    this.title = title;
    this.author = author;
    this.isbn = isbn;
...
// in above line, the book inventory created in previous class is called so that we can compare it when retrieving the book
